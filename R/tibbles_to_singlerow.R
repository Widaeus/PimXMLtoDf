# testing environment # work in progress
library(tidyverse)
library(xml2)


mean_perf_xml <- "C:/Users/oesma/Desktop/Doktorand/PhDproject/PimXMLtoDf/sandbox/CV01_dag1_meanperf.xml"
mean_perf_recinfo_xml <- "C:/Users/oesma/Desktop/Doktorand/PhDproject/PimXMLtoDf/sandbox/CV01_dag1_meanperf_recinfo.xml"
mean_perf_recinfo_calc_xml <- "C:/Users/oesma/Desktop/Doktorand/PhDproject/PimXMLtoDf/sandbox/CV01_dag1_meanperf_recinfo_calculations.xml"
mean_perf_recinfo_calc_roi_xml <- "C:/Users/oesma/Desktop/Doktorand/PhDproject/PimXMLtoDf/sandbox/CV01_dag1_meanperf_recinfo_calculations_percentchangeroi.xml"


ns <- c(ss = "urn:schemas-microsoft-com:office:spreadsheet")

# Read the XML file
xml_data <- read_xml(mean_perf_recinfo_calc_roi_xml)
...
var_calcdata$cell_data <- gsub(" ", "", var_calcdata$cell_data)
